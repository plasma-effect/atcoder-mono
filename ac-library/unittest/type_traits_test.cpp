...
#ifdef LOCAL_DEBUG
static_assert(internal::integral<bool>);
static_assert(internal::integral<int>);
static_assert(!internal::integral<A>);

static_assert(internal::signed_integral<signed char>);
static_assert(internal::signed_integral<short>);
static_assert(internal::signed_integral<int>);
static_assert(internal::signed_integral<long>);
static_assert(internal::signed_integral<long long>);

static_assert(!internal::signed_integral<bool>);
static_assert(!internal::signed_integral<unsigned char>);
static_assert(!internal::signed_integral<unsigned short>);
static_assert(!internal::signed_integral<unsigned int>);
static_assert(!internal::signed_integral<unsigned long>);
static_assert(!internal::signed_integral<unsigned long long>);

static_assert(!internal::unsigned_integral<signed char>);
static_assert(!internal::unsigned_integral<short>);
static_assert(!internal::unsigned_integral<int>);
static_assert(!internal::unsigned_integral<long>);
static_assert(!internal::unsigned_integral<long long>);

static_assert(internal::unsigned_integral<bool>);
static_assert(internal::unsigned_integral<unsigned char>);
static_assert(internal::unsigned_integral<unsigned short>);
static_assert(internal::unsigned_integral<unsigned int>);
static_assert(internal::unsigned_integral<unsigned long>);
static_assert(internal::unsigned_integral<unsigned long long>);

static_assert(!internal::signed_integral<A>);
static_assert(!internal::unsigned_integral<A>);
#else
...
#ifdef LOCAL_DEBUG
static_assert(internal::integral<__int128_t>);
static_assert(internal::integral<__uint128_t>);
static_assert(internal::integral<__int128>);
static_assert(internal::integral<unsigned __int128>);

static_assert(internal::signed_integral<__int128_t>);
static_assert(!internal::signed_integral<__uint128_t>);
static_assert(internal::signed_integral<__int128>);
static_assert(!internal::signed_integral<unsigned __int128>);

static_assert(!internal::unsigned_integral<__int128_t>);
static_assert(internal::unsigned_integral<__uint128_t>);
static_assert(!internal::unsigned_integral<__int128>);
static_assert(internal::unsigned_integral<unsigned __int128>);
#else
